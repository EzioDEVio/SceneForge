...
check('odd widths snap to an allowed size',client.get(f"/api/assets/{img_a['id']}/thumbnail?w=9999").status_code==200 and (t/'proxies'/'thumbs'/(img_a['id']+'_640.jpg')).exists())
